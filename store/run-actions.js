...
export const addRun=(track_image, date, day, lapsedTime, totalDistance,averagePace)=>{
	return async dispatch=>{
        ...
        const dbResult= await insertRun(filePath,date.toString(),day.toString(),lapsedTime.toString(),totalDistance.toString(),averagePace.toString());
        ...
        dispatch({type: ADD_RUN, run: {id: dbResult.insertId.toString(), track_image: filePath, date: date.toString(), day: day.toString(),lapsedTime: lapsedTime.toString(),totalDistance: totalDistance.toString(), averagePace: averagePace.toString()}});

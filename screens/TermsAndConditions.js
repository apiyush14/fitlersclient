	 ...
	 <View style={styles.termsAndConditionsContainerStyle}>
	  <ScrollView style={styles.termsAndConditionsScrollViewStyle}>
        <Text style={styles.largeTextStyle}>Terms & Conditions (T&C)</Text>
         <Text style={styles.smallTextStyle}>This document is an electronic record in terms of Information Technology Act, 2000 and rules made thereunder and the same may be amended from time to time. Being a system generated electronic record, it does not require any physical or digital signature. Greetings from fitlers (hereinafter referred to as the “App”). The App is owned by Piyush Arora, an individual(hereinafter referred to as “We” or “Our” or “Us”).
By accessing Our App from any computer device, mobile, smartphone or any electronic device, You (hereinafter referred to as “You” or “Your”) expressly agree to be bound by these App related Terms and Conditions (hereinafter referred to as the “App Terms and Conditions”).
...
The App has an in-built tracking system whereby it keeps a track of users’ running distance and location and based on this tracked distance and location, the user is able to get a complete view of the running/walking activities.
The App is provided currently free of cost. Currently, this App is not applicable for cycling or any other activity except for running/jogging/walking. If any such activity is permitted at any later date, then these App Terms and Conditions will be applicable to the same as well.
         </Text>
        <Text style={styles.mediumTextStyle}>ACCEPTANCE OF TERMS, ETC.</Text>
         <Text style={styles.smallTextStyle}>These App Terms and Conditions is in the form of an electronic and legally binding contract that establishes the terms and conditions You have accepted before using the App or any part thereof. These include Our Privacy Policy and Other Policies as mentioned in these App Terms and Conditions as well as other specific policies and terms and conditions disclosed to You. By using the App, You hereby unconditionally consent and accept to these App Terms and Conditions, Privacy Policy and Other Policies. To withdraw such consent, You must immediately cease using the App and terminate Your account with Us. You are requested to keep a physical copy of these App Terms and Conditions and all other referred policies herein for Your records.
...
In order to use the App, You have the option of signing in using Your Mobile Number and Your basic personal details (Name, Height and Weight). If You do so, You authorize Us to access and use these details within the application.
...
By agreeing to these App Terms and Conditions, You grant Us the permission to send electronic communications to You as part of Our offering. This includes but is not limited to sending emails, newsletters, notifications and promotional offers from Us and Our partners. Should You no longer wish to receive such electronic communications, You may write to Us at fitlerscommunity@gmail.com
...
It is hereby expressly clarified that any of the aforesaid acts undertaken by You shall be Your sole liability, responsibility, risk and consequences and You hereby agree to indemnify Us for the same.
...
You undertake not to copy, modify, publish, transmit, distribute, perform, display, commercially use/exploit, sell or use such information in any way and for any purpose whatsoever.
...
hit Our servers/use a code/ undertake in any fraudulent activities to emulate run distance
         </Text>
...
hinders the App functionality in any way or interferes or affects other App users’ use and enjoyment of the App; or violates any applicable law for the time being in force.
...
We may occasionally update these App Terms and Conditions. When We post any changes, We will revise the "last updated" date. We recommend that You check Our App from time to time to keep Yourself updated of any changes in this App Terms and Conditions or any of Our Policies.
        ...
        <Text style={styles.mediumTextStyle}>GRIEVANCE OFFICER</Text>
         <Text style={styles.smallTextStyle}>
In accordance with Information Technology Act, 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below:

Name: Mr. Piyush Arora Email: fitlerscommunity@gmail.com
         </Text>
        <Text style={styles.mediumTextStyle}>CONTACT US</Text>
         <Text style={styles.smallTextStyle}>
Please contact Us by email on fitlerscommunity@gmail.com for any questions or comments regarding these App Terms and Conditions.
